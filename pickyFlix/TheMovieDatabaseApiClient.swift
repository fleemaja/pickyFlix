...
class TheMovieDatabaseApiClient {
    ...
    public func getMovies(page: Int, sortType: String, rating: String, startDate: String, endDate: String, genre: String, handler: @escaping (_ data: Data?, _ response: AnyObject?, _ error: String?) -> Void) {
        let url = constructURLString(page: page, sortType: sortType, rating: rating, startDate: startDate, endDate: endDate, genre: genre)
    ...
    func constructURLString(page: Int, sortType: String, rating: String, startDate: String, endDate: String, genre: String) -> String {
