...
class TheMovieDatabaseApiClient {
    ...
    public func getMovies(page: Int, sortType: String, rating: String, startDate: String, endDate: String, handler: @escaping (_ data: Data?, _ response: AnyObject?, _ error: String?) -> Void) {
        let url = constructURLString(page: page, sortType: sortType, rating: rating, startDate: startDate, endDate: endDate)
    ...
    func constructURLString(page: Int, sortType: String, rating: String, startDate: String, endDate: String) -> String {
